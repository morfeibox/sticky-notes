function setCookie(cname, cvalue, days) {
    ...
    document.cookie = cname + "=" + JSON.stringify(cvalue) +"; expires=" + date.toGMTString() + '; domain= .abeychev.tk;';
...
function delete_cookie(name) {
    document.cookie = name +'=; domain= .abeychev.tk; Expires=Thu, 01 Jan 1970 00:00:01 GMT;';
}
